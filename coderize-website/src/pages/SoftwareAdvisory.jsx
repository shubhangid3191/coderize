...
import SoftwareAdvisoryIntro from "../assets/SoftwareAdvisoryIntro.jpg";
import SoftwareAdvisorySchedule from "../assets/SoftwareAdvisorySchedule.jpg";
...
const services = [
  {
    ...
    title: "Gap Analysis",
    description: "We identify business process gaps through thorough assessments for continuous growth.",
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description: "We create seamless, engaging user experiences across platforms, driven by user behavior and industry trends.",
  ...
  },
  {
    ...
    description: "Our design process starts with understanding your vision and requirements.",
  ...
  },
  {
    ...
    description: "We handle every aspect of the integration process with precision and expertise.",
  ...
  },
  {
    ...
    description: "We assess your unique needs and develop tailored support plans aligned with your goals.",
  ...
  },
  {
    ...
    description: "We offer end-to-end project management solutions, customized to your needs.",
  ...
  },
  {
    ...
    description: "We optimize digital assets through code refactoring, server tuning, image optimization, and CDN integration.",
  ...
  },
  {
    ...
    description: "We optimize consultancy processes to boost productivity and enhance client satisfaction.",
  ...
  },
  {
    ...
    description: "Our services ensure seamless transitions with minimal downtime and data loss.",
  ...
  },
  {
    ...
    description: "We guide smooth change management and foster seamless adoption of new processes and systems.",
  ...
  },
  {
    ...
    description: "We assess security needs, implement tailored strategies, and ensure compliance with ongoing monitoring and support.",
        ...
        <Box sx={{
          ...
          <Container maxWidth="xl" sx={{
            ...
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" sx={{ color: "rgba(255,255,255,0.45)" }} />} sx={{ mb: 2.5 }}>
              {["Home", "Services", "Software", "Advisory"].map((c, i, arr) => (
            ...
            <Typography variant="h3" sx={{
              ...
              Navigating Complexity with Expert Technical Solutions
            </Typography>
          </Container>
        </Box>
              ...
              <Box sx={{
                ...
                <Box sx={{ position: "relative", zIndex: 1, maxWidth: 650 }}>
                  <Typography sx={{
                    ...
                    Collaborate with software advisors to drive success.
                  </Typography>
                  <Typography sx={{
                    fontFamily: '"Sora", sans-serif',
                    color: "#3d5a73",
                    ...
                    Our software advisory team offers expert guidance to streamline technology and maximize business efficiency.
                  </Typography>
                </Box>
              </Box>
            </Box>
        ...
        <Box sx={{
          ...
          <Box sx={{ position: "relative", zIndex: 1, textAlign: "center", px: { xs: 3, md: 6 } }}>
            <Typography sx={{
              ...
              Get tailored guidance for your business
            </Typography>
            <Button
              component={Link}
              to="/Contact"
