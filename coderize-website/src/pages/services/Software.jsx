...
const solutionCards = [
  {
    ...
    desc: "Our agile, cross-functional teams create scalable web and mobile applications that deliver...",
    img: soft1,
    path: "/ApplicationDevelopment",
  },
  {
    title: "Azure Consulting",
    desc: "We provide expert Azure consulting and reengineering to drive scalable, innovative cloud solutions...",
    img: soft2,
    path: "/AzureConsulting",
  },
  {
    title: "Advisory",
    desc: "We offer expert software advisory services to help businesses make informed technology decisions...",
    img: soft3,
    path: "/SoftwareAdvisory",
  },
  {
    title: "Technical Support",
    desc: "We provide comprehensive software technical support to ensure seamless operation and quick resolution...",
    img: soft4,
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            >
              Driving Innovation with Tailored Software Solutions
            </Typography>
            <Typography
              sx={{
                color: "#4a6070",
            ...
            >
              Delivering cutting-edge software services designed to optimize
              performance, drive innovation, and meet your unique business
              needs.
            </Typography>
          </Box>
          <Box
          ...
          >
            <Box
              ...
              onError={(e) => {
                e.target.src =
                  "https://coderize.in/wp-content/uploads/2024/10/application-developemnt-mockup.png";
