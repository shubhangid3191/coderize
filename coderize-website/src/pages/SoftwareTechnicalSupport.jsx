...
import SoftwareTechnicalIntro from "../assets/SoftwareTechnicalIntro.jpg";
import SoftwareTechnicalSchedule from "../assets/SoftwareTechnicalSchedule.jpg";
...
const services = [
  {
    ...
    description: "We provide software development support with code review, bug fixing, & performance optimization for timely, on-budget delivery.",
  ...
  },
  {
    ...
    description: "We offer essential server management services to ensure optimal performance and efficiency.",
  ...
  },
  {
    ...
    description: "We assist clients in maintaining and enhancing the performance of their software applications.",
  ...
  },
  {
    ...
    description: "We help organizations manage and optimize their databases for peak efficiency.",
  ...
  },
  {
    ...
    description: "We provide expert scripting and automation services to optimize processes and boost efficiency.",
...
export default function SoftwareTechnicalSupport() {
  const {
    CASE_GAP,
    loopedItems,
    activeDot,
        ...
        <Box sx={{
          ...
          <Container maxWidth="xl" sx={{
            ...
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" sx={{ color: "rgba(255,255,255,0.45)" }} />} sx={{ mb: 2.5 }}>
              {["Home","Services","Software","Technical Support"].map((c, i, arr) => (
            ...
            <Typography variant="h3" sx={{
              ...
              Reliable Software Tech Support
            </Typography>
          </Container>
        </Box>
              ...
              <Box sx={{
                ...
                <Box sx={{ position: "relative", zIndex: 1, maxWidth: 650 }}>
                  <Typography sx={{
                    ...
                    Navigate Software Hurdles with Dedicated Technical Assistance.
                  </Typography>
                  <Typography sx={{
                    fontFamily: '"Sora", sans-serif',
                    color: "#3d5a73",
                    ...
                    We offer tailored software support that optimizes performance, reduces downtime, and keeps systems ahead.
                  </Typography>
                </Box>
              </Box>
            </Box>
