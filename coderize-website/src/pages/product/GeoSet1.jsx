...
const flipFeatures = [
  ...
  },
  {
    ...
    title: "Geo Tagging",
    description: "Allows to capture precise location with geo-tagging for data accuracy.",
    bullets: ["Field Data Collection", "Visual Evidence", "Accuracy & Precision"],
  },
  {
  ...
  },
  {
    ...
    title: "Data Reporting & Editing",
    description: "Generates reports and allows easy data editing on the go.",
    bullets: ["Custom Report & Visualization", "Data Editing & Validation", "Data Management & Conflict Resolution"],
  },
  {
    icon: <WebMappingIcon />,
  ...
  },
  {
    ...
    description: "Allows the capture and associate of multimedia (photos, videos) with geospatial data for comprehensive documentation.",
    bullets: ["Image Collection", "Video Recording", "Export & Sharing"],
  },
];

const slides = [
  { title: "Spatial Data Collection", bullets: ["Attach Visual evidence", "Works Without ths internet", "Auto-sync on network"], imgSrc: Set2, imgAlt: "Grant Work Approvals" },
  { title: "Accurte Spatial Data", bullets: ["Precise Location", "GPS tracking", "Custom Forms"], imgSrc: Set3, imgAlt: "Beyond Auditing" },
  { title: "Survey Application", bullets: ["Role based Access", "Crowdsource app", "Forms wide user base"], imgSrc: Set4, imgAlt: "Spatial Monitoring" },
  { title: "Rich User Interface", bullets: ["User friendly design", "visually enhanced data", "Custom reports"], imgSrc: Set5, imgAlt: "Collaborative Workflows" },
  { title: "Save Papers & Environment", bullets: ["Reduce paperwork", "Save Environment", "Optimize resources & cost"], imgSrc: Set6, imgAlt: "Collaborative Workflows" },
];
...
// ─── Main Page ────────────────────────────────────────────────────────────
export default function GeoSet1() {
  return (
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ bgcolor: "#fff", overflow: "hidden", fontFamily: "'Poppins', sans-serif" }}>
            ...
            <Box sx={{ display: "flex", flexDirection: { xs: "column", md: "row" }, alignItems: "center", gap: { xs: 6, md: 8 } }}>
              ...
              <Box sx={{ flex: 1, minWidth: 0, zIndex: 1 }}>
                ...
                <Typography sx={{ color: "#2d3d4e", fontSize: { xs: "0.95rem", md: "1rem" }, lineHeight: 1.8, mb: 2 }}>
                  It is a mobile app that simplifies capturing accurate spatial data and sending it to the office in real time.
                </Typography>

                <Box component="ul" sx={{ listStyle: "none", p: 0, m: 0 }}>
                  {[
                    "Capture and send spatial data in real time from mobile device.",
                    "Works offline, syncing when reconnected",
                    "Integrates seamlessly with GeoSets Viewer for live updates.",
                  ].map((item) => (
              ...
              <Box sx={{ flex: { xs: "none", md: "0 0 45%" }, width: { xs: "100%", md: "45%" }, maxWidth: { xs: "100%", md: 520 }, overflow: "hidden", borderRadius: 2, zIndex: 1 }}>
                <Box component="img" src={Set1} alt="GeoSphere platform" sx={{ width: "100%", height: "auto", display: "block", maxHeight: { xs: 400, md: 480 }, objectFit: "contain", objectPosition: "center" }} />
              </Box>
            </Box>
          </Container>
        </Box>
        ...
        {/* 3. CTA */}
        <Box sx={{ position: "relative", py: { xs: 8, md: 10 }, overflow: "hidden", backgroundImage: `url(${Set1})`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
