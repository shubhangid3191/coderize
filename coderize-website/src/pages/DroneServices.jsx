...
import DroneIntro from "../assets/DroneIntro.jpg";
import DroneSchedule from "../assets/DroneSchedule.jpg";
...
// Page data
const stats = [
  { value: "50+", label: "Successful flights (in hrs)" },
  { value: "50K+", label: "Acres Area Mapped" },
  { value: "5+", label: "Projects Completed" },
  { value: "10+", label: "Certified Pilots" },
];
...
const services = [
  {
    ...
    description: "Utilize drones to conduct accurate and efficient aerial surveys and mapping for slope monitoring, Land survey, Urban development, mining.",
    bullets: ["Land Surveying", "Cadastral Mapping", "3D Mapping & Modeling"],
  },
  {
    icon: <FoundationIcon sx={{ fontSize: 56, color: ACCENT }} />,
    title: "Drone Infrastructure",
    description: "Implement drone-based infrastructure and logistics solutions for improved delivery, transportation, and operational efficiency.",
    bullets: ["Construction Site Monitoring", "Inventory & Asset Management"],
  },
  {
    icon: <VisibilityIcon sx={{ fontSize: 56, color: ACCENT }} />,
    title: "Inspection & Surveillance",
    description: "Deploy drones for thorough inspection and surveillance, ensuring safety and compliance in hard-to-reach or hazardous areas.",
    bullets: ["Aerial Inspection for Utilities", "Security Surveillance", "Environmental Monitoring"],
  },
  {
    icon: <FactoryIcon sx={{ fontSize: 56, color: ACCENT }} />,
    title: "Industrial Enterprise Solutions",
    description: "Integrate drone technology into industrial operations to enhance productivity, monitoring, and data collection for informed decision-making.",
    bullets: ["Digital Transformation", "Asset Tracking & Management"],
  },
  {
    icon: <PhotoCameraIcon sx={{ fontSize: 56, color: ACCENT }} />,
    title: "UAV Data Processing",
    description: "Achieving centimeter-level accuracy, our UAV solutions provide topographical maps, including Digital Terrain Models, Digital Surface Models, Contour Maps, and Orthomosaic Maps, with deliverables such as detailed reports and actionable insights.",
    bullets: ["Photogrammetry & 3D Modeling", "LiDAR Data Processing", "Digital Elevation Models"],
  },
];
        ...
        <Box sx={{
          ...
          <Container maxWidth="xl" sx={{
            ...
            <Breadcrumbs separator={<NavigateNextIcon fontSize="small" sx={{ color: "rgba(255,255,255,0.45)" }} />} sx={{ mb: 2.5 }}>
              {["Home", "Services", "Geospatial", "Drone Services"].map((c, i, arr) => (
            ...
            <Typography variant="h3" sx={{
              ...
              Redefine Aerial Innovation with us
            </Typography>
          </Container>
        </Box>
              ...
              <Box sx={{
                ...
                <Box sx={{ position: "relative", zIndex: 1, maxWidth: 650 }}>
                  <Typography sx={{
                    ...
                    Unveiling Our Expertise in Aerial Mastery
                  </Typography>
                  <Typography sx={{
                    fontFamily: '"Sora", sans-serif',
                    color: "#3d5a73",
                    ...
                    We offer end-to-end industrial UAV solutions globally, delivering precision and efficiency for aerial photography, surveying, and infrastructure inspection. Our expert team ensures top-notch results with cutting-edge technology and adherence to industry standards.
                  </Typography>
                </Box>
              </Box>
            </Box>
